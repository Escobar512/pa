...
int WINAPI WinMain(
	HINSTANCE hInstance,     // Manejador de la aplicación
	HINSTANCE hPrevInstance, // Atributo histórico
	LPSTR lpszCmdParam,      // Atributos de CMD
	int nCmdShow             // Cómo se mostrará la ventana
) {
